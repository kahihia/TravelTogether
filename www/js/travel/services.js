  ...
  .service('TravelService', ['$q', 'ParseConfiguration',
    function($q, ParseConfiguration) {
      ...
      return {
        ...
        addCommentToTravel: function(profile, _travelId, text) {
          var defered = $q.defer();
          var myComment = new Comment();
          myComment.set('text', text);
          myComment.set('profile', profile);
          myComment.set('travel_id', _travelId);
          myComment.save(null, {
            ...
            error: function(comment, error) {
              alert('Failed to add comment, with error code: ' + error.message);
